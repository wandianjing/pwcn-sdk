 ...
 */
module.exports = function pwcnMethod(spec) {
  ...
  return function() {
    ...
    for (var i = 0, l = urlParams.length; i < l; ++i) {
      ...
      if (!arg) {
        ...
        throw new Error('Pwcn: I require argument "' + urlParams[i] + '", but I got: ' + arg);
      }
    ...
    if (args.length) {
      throw new Error(
        'Pwcn: Unknown arguments (' + args + '). Did you mean to pass an options object?'
      );
    }
